...
<!-- 													   <input type="text" class="form-control"  name="epid"  id="epid"  placeholder="设备编号" value="JDY20180928-044" readonly="readonly" style="background-color: white" onchange="showPic();" > -->
							  							   <input type="text" class="form-control"  name="epId"  id="epId"  placeholder="设备编号" value=""  style="background-color: white" onchange="showEquipment();" style="background-color: white"  >
											...
											<div class="form-group">
												<label>设备名称</label>
												<div>
													<input type="text" class="form-control" name="epName"  id="epName"   placeholder="设备名称" readonly="readonly" style="background-color: white"  />
												</div>
											</div>
											...
											<div class="form-group">
												<label>规格型号</label>
												<div>
													<input type="text" class="form-control" name="epModelNum"  id="epModelNum"   placeholder="规格型号" readonly="readonly" style="background-color: white" />
												</div>
											</div>
											<div class="form-group">
												<label>安装地点</label>
												<div>
													<input  type="text" class="form-control"   name="epLocation"  id="epLocation" placeholder="安装地点" readonly="readonly" style="background-color: white" />
												</div>
											</div>
											<div class="form-group">
												<label>设备类型</label>
												<div>
													<input  type="text" class="form-control"  name="epTypeName"  id="epTypeName"  placeholder="设备类型" readonly="readonly" style="background-color: white" />
												</div>
											</div>
										</div>
									</div>
...
<!------------------故障报修 -------------------------------------------------------------------------------------------->
										...
										<div>
											<div class="form-group">
												<label>报修时间</label>
												<div>
													<input  type="text" class="form-control"   name="eprCkTime"  id="eprCkTime" placeholder="报修时间" readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											<div class="form-group">
												<label>故障情况拍照</label>
