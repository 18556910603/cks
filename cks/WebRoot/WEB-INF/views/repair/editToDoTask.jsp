							...
							<div class="col-lg-6">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<p class="text-muted m-b-30 font-14">待处理的设备报修工单</p>
...
<!-- 													   <input type="text" class="form-control"  name="epid"  id="epid"  placeholder="设备编号" value="JDY20180928-044" readonly="readonly" style="background-color: white" onchange="showPic();" > -->
							  							   <input type="text" class="form-control"  name="epId"  id="epId"  placeholder="设备编号" value="${mEquipmentRepairT.epId}" readonly="readonly" style="background-color: white" onchange="showEquipment();" >
											...
											<div class="form-group">
												<label>设备名称</label>
												<div>
													<input type="text" class="form-control" name="epName"  id="epName"   placeholder="设备名称" value="${mEquipmentRepairT.epHomeEquname}"  readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											...
											<div class="form-group">
												<label>规格型号</label>
												<div>
													<input type="text" class="form-control" name="epModelNum"  id="epModelNum"   placeholder="规格型号"  value="${mEquipmentRepairT.epModelNum}" readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											<div class="form-group">
												<label>安装地点</label>
												<div>
													<input  type="text" class="form-control"   name="epLocation"  id="epLocation" placeholder="安装地点" value="${mEquipmentRepairT.epLocation}" readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											<div class="form-group">
												<label>设备类型</label>
												<div>
													<input  type="text" class="form-control"  name="epTypeName"  id="epTypeName"  placeholder="设备类型" value="${mEquipmentRepairT.epHomeEqutype}" readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											<div class="form-group">
												<label>报修时间</label>
												<div>
													<input  type="text" class="form-control"   name="eprCkTime"  id="eprCkTime" placeholder="报修时间" value="${mEquipmentRepairT.eprCkTime}" readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											<div class="form-group">
												<label>故障情况拍照</label>
...
<!-- 												拍照签到的图片值 -->
												<input type="text" class="form-control" placeholder="拍照签到"
														value="${mEquipmentRepairT.eprCkPhoto}" name="eprCkPhoto" id="eprCkPhoto" style="display:none"/>													
											</div>
											<div class="form-group">
												<label>故障情况描述</label>
												<div>
													<textarea required class="form-control" rows="5"  name="eprCkDescribe"  id="eprCkDescribe" style="background-color: white" readonly="readonly" >${mEquipmentRepairT.eprCkDescribe}</textarea>
<%-- 													<input  type="text" class="form-control"   name="eprCkDescribe"  id="eprCkDescribe" placeholder="故障情况描述"style="background-color: white" value="${mEquipmentRepairT.eprCkDescribe}" /> --%>
												</div>
											</div>
											<div class="form-group">
												<label>报修人</label>
												<div>
													<input  type="text" class="form-control"   name="eprCkIdName"  id="eprCkIdName"   value="${mEquipmentRepairT.userIdName}"     placeholder="报修人"  readonly="readonly" style="background-color: white"/>
												</div>
											</div>
											...
											<div class="form-group" style="display:none	">
												<label>报修人ID</label>
												<div>
													<input  type="text" class="form-control"   name="userId"  id="userId" value="${mEquipmentRepairT.userId}"  placeholder="报修人ID" />
												</div>
											</div>											
									 ...
									 <div style="display:none" id="leaderDispatch" >
                                           <div class="form-group" >
											...
											<div class="form-group">
												<label>故障类别</label>
												<div>
													<select class="form-control" id="epReKind" name="epReKind" style="background-color: white">
											...
											<div class="form-group">
												<label>维修责任人</label>
												<div>
													<select class="form-control" id="epReId" name="epReId" style="background-color: white">
														<option value="">----请选择----</option>
									...
									<div style="display:none"id="repair">										
                                           <div class="form-group" >
											...
											<div class="form-group">
												<label>维修情况说明</label>
												<div>
													<textarea required class="form-control" rows="5"  name="epReDescribe"  id="epReDescribe" style="background-color: white" >${mEquipmentRepairT.epReDescribe}</textarea>
<%-- 													<input  type="text" class="form-control"   name="epReDescribe"  id="epReDescribe" value="${mEquipmentRepairT.epReDescribe}" placeholder="维修情况说明" /> --%>
												</div>
											</div>
											<div class="form-group">
												<label>维修完成时间</label>
												<div>
													<input  type="text" class="form-control"   name="epReTime"  id="epReTime" value="${mEquipmentRepairT.epReTime}"  placeholder="维修完成时间" />
												</div>
											</div>
									</div>
<!------------------维修确认-------------------------------------------------------------------------------------------->
									<div style="display:none"  id="confirm">
                                           <div class="form-group" >
											...
											<div class="form-group">
												<label>设备状态</label>
												<div>
													<select class="form-control" id="epReStatus" name="epReStatus"  onchange="gradeChange()">
														<option value="">----请选择----</option>
											...
											<div class="form-group">
												...
												<div>
													<input type="text" class="form-control" placeholder="保养时间"   style="background-color: white" readonly="readonly"
														value="${mEquipmentRepairT.maintenanceDate}" name="maintenanceDate" id="maintenanceDate" />
												</div>
											</div>
											<div class="form-group">
												...
												<div>
													<input type="text" class="form-control" placeholder="剩余天数"   style="background-color: white;color: red" readonly="readonly"
														value="${mEquipmentRepairT.distanceDays}" name="distanceDays" id="distanceDays" />
												</div>
											</div>						
											<div class="form-group">
												<label>保养注意事项</label>
	...
	<!-- jQuery  -->
       ...
       //初始化图片预览
        function init(){
        	 ...
        	 var eprCkPhoto='${mEquipmentRepairT.eprCkPhoto}';      
        	 var arr= new Array();
        ...
        function initDiv(){
        	...
        	//获取下一个节点
        	 var epAcNextid='${mEquipmentRepairT.epAcNextid}'; 
        	 ...
        	 if(epAcNextid=='1'){
        		...
        		//2.主管派单
        		 ...
        		 //3.维修中（维修确认）
        		 $("#leaderDispatch").show();     
        		 $("#epReKind").val('${mEquipmentRepairT.epReKind}');
        		 $("#epReId").val('${mEquipmentRepairT.epReId}');
        		 $("#epReKind").attr("disabled","disabled");
        		 $("#epReId").attr("disabled","disabled");
        		 $("#repairALL").show();    
        		 $("#repair").show();     
        			//时间
        		 $("#epReTime").val(CurentTime());	
				// 维修记录新增
        		 $("#rpAdd").show();     
        ...
        function save()
        {
     	       ...
     	       form_data=form_data+"&equipmentrepairId="+'${mEquipmentRepairT.equipmentrepairId}';
     	    $.ajax(
     	            {
...
//      	                	location.reload(true);
        ...
        function repAdd()
        {
     	    ...
     	    $.ajax(
     	            {
     	                url: "${proPath}/equipmentRepair/rpAdd.action",
     					data:form_data,
     	                type: "post",
     	                async:false,
     	                beforeSend:function()
	       ...
	       function gradeChange(){
	           ...
	           var objS = document.getElementById("epReStatus");
