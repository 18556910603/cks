                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">临时保养任务总览</h4>
                                            <p class="text-muted m-b-30 font-14">展示所有临时保养任务.</p>
...
<%-- 														<td>${electricalCheckT.epName}</td> --%>
														...
														<td><a class="nav-link active" href="${proPath}/electricalMaintain/displayOneByIdAll.action?maintainId=${ElectricalMaintain.maintainId}">查看</a></td>
													</tr>
												</c:forEach>
