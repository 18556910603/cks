                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">已提交的临时保养单</h4>
                                            <p class="text-muted m-b-30 font-14">已经提交的临时保养单记录</p>
...
<%-- 														<td>${electricalCheckT.epName}</td> --%>
														...
														<td><a class="nav-link active" href="${proPath}/electricalMaintain/displayOneByIdCom.action?maintainId=${ElectricalMaintain.maintainId}">查看</a></td>
													</tr>
												</c:forEach>
