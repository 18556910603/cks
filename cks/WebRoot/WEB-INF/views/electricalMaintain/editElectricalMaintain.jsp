							...
							<div class="col-lg-6">
								<div class="card m-b-30">
									<div class="card-body">
										...
										<h4 class="mt-0 header-title">待处理临时保养单明细</h4>
										<p class="text-muted m-b-30 font-14">用于展示等待处理的临时保养单明细.</p>
...
<!--                                             <h4 class="mt-0 header-title"></h4> -->
						...
						<!-- 加入保养明细-->
											...
											<div class="form-group">
												<label>保养情况描述</label>
												<div>
												<textarea required class="form-control" rows="5"  name="maintainDescribe"  id="maintainDescribe"  style="background-color: white; "  ></textarea>
												</div>
											</div>											
											<div class="form-group">
...
<!-- 														class="btn btn-secondary waves-effect m-l-5">清空</button> -->
   ...
   //初始化图片预览
    function init(){
		//时间
		document.getElementById('maintainTime').value = CurentTime() ;
		//获取当前时间		 
	...
	function save() {
		...
		form_data=form_data+"&maintainId="+'${mElectricalMaintainT.maintainId}';
		$
				.ajax({
					url : "${proPath}/electricalMaintain/update.action",
					data : form_data,
					type : "post",
					async : false,
					beforeSend : function() {
